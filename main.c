...
static void bind_window_timeout(void * p_context);
...
static void timers_init(void)
{
    ...
    err_code = app_timer_create(&m_bind_timer, APP_TIMER_MODE_SINGLE_SHOT, bind_window_timeout);
...
void bsp_event_handler(bsp_event_t event)
{
    ...
    switch (event)
    {
        ...
        case BSP_EVENT_KEY_1:
            ...
            err_code = app_timer_start(m_bind_timer, APP_TIMER_TICKS(5000, APP_TIMER_PRESCALER), NULL);
            MI_ERR_CHECK(err_code);
            break;
